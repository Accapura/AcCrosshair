...
**Прицел (crosshair) поверх экрана для Windows**
Оверлей поверх любых окон и игр — гибкая настройка формы, цвета и размера, профили и горячие клавиши.

![Platform](https://img.shields.io/badge/platform-Windows%2010%2F11-0FB6E4?style=flat-square)
![.NET](https://img.shields.io/badge/.NET-10-512BD4?style=flat-square)
![Version](https://img.shields.io/badge/version-2.1-FF3D5C?style=flat-square)

<br/>

<table>
<tr>
<td width="50%"><img src="docs/screenshot-v2.png" alt="Окно настроек AcCrosshair"/></td>
<td width="50%"><img src="docs/splash-preview.jpg" alt="Заставка AcCrosshair"/></td>
</tr>
</table>
...
| 🗂️ | Несколько сохранённых профилей прицела — форма, цвет, размер, толщина, зазор, точка в центре, обводка |
| 🖥️ | Выбор монитора, на котором рисуется прицел, и смещение от центра экрана по X/Y |
| ⌨️ | Полностью переназначаемые горячие клавиши прямо в окне настроек, без правки файлов |
...
| 🎨 | Тема «Токсичный газ»: асимметричные «мембранные» карточки, фирменный шрифт Chakra Petch, 11 цветовых вариантов акцента — применяется сразу ко всему приложению, включая иконку в трее |
...
Должен быть установлен [.NET 10 Desktop Runtime](https://dotnet.microsoft.com/download/dotnet/10.0) — сам exe рантайм в себе не несёт.
...
|---|---|
| Показать/скрыть прицел | `F6` |
| Следующий профиль | `F7` |
...
**Экспорт/импорт:** в разделе «Профили» кнопки «Экспорт»/«Импорт» сохраняют или загружают весь набор профилей как JSON-файл — удобно, чтобы поделиться своей настройкой с другом или перенести её на другой ПК без переноса всего `settings.json`.
...
Нашли баг или есть идея для новой функции — открывайте [Issues](https://github.com/Accapura/AcCrosshair/issues)
